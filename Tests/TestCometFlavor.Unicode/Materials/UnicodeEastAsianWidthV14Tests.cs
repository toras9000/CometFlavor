...
using static CometFlavor.Unicode.Materials.UnicodeEastAsianWidthV14;

namespace TestCometFlavor.Unicode.Materials;

[TestClass]
public class UnicodeEastAsianWidthV14Tests
{
    [TestMethod]
    public void GetEastAsianWidth_Pattern()
    {
        ...
        GetEastAsianWidth(0x000870).Should().Be(EastAsianWidth.Neutral);
        ...
        GetEastAsianWidth(0x01F979).Should().Be(EastAsianWidth.Wide);
