...
/// <summary>
/// <see cref="ShellSaveFileDialog"/> 呼び出しアクション
/// </summary>
public class ShellSaveFileDialogAction : TriggerAction<DependencyObject>
{
    // 公開プロパティ
    #region 動作設定
    ...
    public static readonly DependencyProperty OwnedProperty = DependencyProperty.Register(nameof(Owned), typeof(bool), typeof(ShellSaveFileDialogAction), new PropertyMetadata(true));
    #endregion
    ...
    protected override void Invoke(object parameter)
    {
        ...
        var actionParam = (ShellSaveFileDialogActionParameter)parameter ?? throw new NullReferenceException();
        ...
        try
        {
            ...
            // ダイアログを表示する
            var shellDlg = new ShellSaveFileDialog();
