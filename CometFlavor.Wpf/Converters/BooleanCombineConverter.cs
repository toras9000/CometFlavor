...
/// <summary>
/// 複数のbool値を結合して1つの論理値に変化する。
/// </summary>
public class BooleanCombineConverter : IMultiValueConverter
{
    // 公開型
    #region 種別定義
    ...
    public enum CombineMode
    {
        ...
        AllTrue,
        /// <summary>全て false の場合に結果を true とする。それ以外は false とする。</summary>
        AllFalse,
        /// <summary>1つでも true があれば結果を true とする。それ以外は false とする。</summary>
        AnyTrue,
        /// <summary>1つでも false があれば結果を true とする。それ以外は false とする。</summary>
        AnyFalse,
    }
    #endregion
