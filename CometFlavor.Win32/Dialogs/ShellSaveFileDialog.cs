...
public class ShellSaveFileDialog
{
    ...
    public ShellSaveFileDialogResult ShowDialog(IntPtr owner, ShellSaveFileDialogParameter parameter)
    {
    ...
    {
        // ダイアログを表示する
        return showInternal(IntPtr.Zero, parameter);
    }
    #endregion
    ...
    /// <param name="parameter">ダイアログ表示パラメータ</param>
    /// <returns>ダイアログの結果</returns>
    private ShellSaveFileDialogResult showInternal(IntPtr owner, ShellSaveFileDialogParameter parameter)
    {
